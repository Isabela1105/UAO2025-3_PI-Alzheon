...
import { HiArrowLeft, HiMicrophone, HiPhoto, HiUserPlus, HiBeaker, HiSparkles } from 'react-icons/hi2'
import {
  PatientDetails,
  MedicoPhoto,
  MedicoRecording,
...
import { OrientacionMedico } from '../OrientacionMedico/OrientacionMedico'
...
export const MedicoPatientDetail = ({
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'fotos' | 'grabaciones' | 'analisis' | 'orientacion'>('general')
  ...
  return (
    <section className="w-full px-4 pb-16 sm:px-6">
      ...
      {/* Orientación (Tab) */}
      {activeTab === 'orientacion' && pacienteId && (
        <OrientacionMedico pacienteId={pacienteId} />
      )}
