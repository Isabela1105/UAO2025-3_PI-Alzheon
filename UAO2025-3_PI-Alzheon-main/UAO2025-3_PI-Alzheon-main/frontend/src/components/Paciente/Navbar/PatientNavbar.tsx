import { HiArrowRightOnRectangle, HiCog6Tooth, HiHome, HiMicrophone, HiPhoto, HiSparkles } from 'react-icons/hi2'
...
const navItems = [
  ...
  { label: 'Orientación', path: '/paciente/orientacion', icon: HiSparkles },
