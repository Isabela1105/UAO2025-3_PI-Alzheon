...
export const fetchAvailableCaregivers = async (): Promise<Caregiver[]> => {
  const { data } = await medicoApiClient.get('/medico/cuidadores')
  return data
}
...
export const assignCaregiverToPatient = async (
  ...
  await medicoApiClient.post('/medico/asignar-cuidador', {
    pacienteId,
    cuidadorId,
  })
}
...
export const fetchLineaBase = async (pacienteId: string): Promise<AnalisisCognitivo> => {
  const { data } = await medicoApiClient.get(`/medico/pacientes/${pacienteId}/linea-base`)
  return data
}
...
export const fetchAnalisisCognitivo = async (
  ...
  const { data } = await medicoApiClient.get(`/medico/pacientes/${pacienteId}/analisis`, {
    params,
  })
  return data
}
...
export const fetchAlertas = async (): Promise<AlertaCognitiva[]> => {
  const { data } = await medicoApiClient.get('/medico/alertas')
  return data
}
...
export const fetchHistorialAlertas = async (params?: {
  ...
  const { data } = await medicoApiClient.get('/medico/alertas/historial', { params })
  return data
}

// Marcar alerta como leída
export const marcarAlertaLeida = async (alertaId: string): Promise<AlertaCognitiva> => {
  const { data } = await medicoApiClient.post(`/medico/alertas/${alertaId}/leer`)
  return data
}
...
export const registrarAccionAlerta = async (
  ...
  const { data } = await medicoApiClient.post(`/medico/alertas/${alertaId}/accion`, accion)
  return data
}
...
export const actualizarUmbrales = async (config: {
  ...
  await medicoApiClient.put('/medico/configuracion/umbrales', config)
}
...
export const generarReporte = async (
  ...
  const response = await medicoApiClient.get(`/medico/pacientes/${pacienteId}/reporte`, {
    params,
