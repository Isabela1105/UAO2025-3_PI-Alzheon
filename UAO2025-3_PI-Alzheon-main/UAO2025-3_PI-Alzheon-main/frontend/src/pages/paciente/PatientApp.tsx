...
import { TestOrientacion } from '../../components/Paciente/TestOrientacion/TestOrientacion'
import { EstadisticasOrientacion } from '../../components/Paciente/TestOrientacion/EstadisticasOrientacion'
import {
  PatientPhoto,
  PatientProfile,
  PatientRecording,
    ...
    <div className="min-h-screen flex flex-col patient-gradient-bg">
      ...
      <main className="flex-1 pb-12">
        ...
        <div className="mx-auto max-w-6xl space-y-10 px-4 sm:px-6">
          ...
          <Route
            path="orientacion"
            element={<TestOrientacion />}
          />
          <Route
            path="orientacion/estadisticas"
            element={<EstadisticasOrientacion />}
          />
