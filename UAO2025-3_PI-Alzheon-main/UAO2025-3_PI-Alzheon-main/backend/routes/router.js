...
import * as orientacionController from '../controllers/orientacionController.js';
...
// ========== RUTAS DE ORIENTACIÓN TEMPORAL Y ESPACIAL ==========

// Obtener test de orientación del día
router.get('/paciente/orientacion',
    authMiddleware,
    requireRole('paciente'),
    orientacionController.obtenerTestDelDia
);

// Responder una pregunta de orientación
router.post('/paciente/orientacion/responder',
    authMiddleware,
    requireRole('paciente'),
    orientacionController.responderPregunta
);

// Reiniciar mi test de orientación
router.post('/paciente/orientacion/reiniciar',
    authMiddleware,
    requireRole('paciente'),
    orientacionController.reiniciarMiTest
);

// Obtener historial de orientación
router.get('/paciente/orientacion/historial',
    authMiddleware,
    requireRole('paciente'),
...
router.get('/paciente/orientacion/estadisticas',
    authMiddleware,
    requireRole('paciente'),
    orientacionController.obtenerEstadisticas
);

// Obtener un test completado
router.get('/paciente/orientacion/:testId',
    authMiddleware,
    requireRole('paciente'),
    orientacionController.obtenerTestCompletado
);

// Médico: obtener historial de orientación de un paciente
router.get('/medico/pacientes/:pacienteId/orientacion',
    authMiddleware,
    requireRole('medico'),
    orientacionController.obtenerHistorialPaciente
);

// Admin/Médico: reiniciar test del día de un paciente
router.post('/medico/pacientes/:pacienteId/orientacion/reiniciar',
    authMiddleware,
    requireRole('medico'),
    orientacionController.reiniciarTestDelDia
);
